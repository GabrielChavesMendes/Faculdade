/*
 Exemplo0100 - v1.6. - _01_ / _03_ / _2024_
 ...
 Saída:
        ...
        x = abc (3)
        y = def (3)
        Entrar com caracteres: Gabriel
        Entrar com outros caracteres: Chaves
        z = [Gabriel]*[Chaves] = [GabrielChaves]
        z = [Gabriel]*[Chaves] = [GabrielChaves]
...
/*
----- Acrescentado o method_07 ----- documentacao complementar
-Uso de funcoes strings para guardar e alterar uma cadeia de caracteres- notas / observacoes / comentarios
---------------------------------------------- previsao de testes
a.) 5
b.) -5
c.) 123456789
