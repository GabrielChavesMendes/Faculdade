/*
 Exemplo0100 - v1.9. - _01_ / _03_ / _2024_
...
/*
-Acrescentado o method_010 e da biblioteca io.h (incluida diretamente no arquivo do projeto)- documentacao complementar
-Entrada, saida e formatacao de dados com auxilio da biblioteca adicionada- notas / observacoes / comentarios
---------------------------------------------- previsao de testes
a.) 5
b.) -5
c.) 123456789
...
Versao Data Modificacao
 ...
 0.7 _01_/_03_ mudanca de versao
 0.8 _01_/_03_ mudanca de versao
 0.9 _01_/_03_ mudanca de versao
 0.10 _01_/_03_ mudanca de versao
---------------------------------------------- testes
Versao Teste
...
0.7 07. ( _OK_ ) identificacao de programa
leitura e exibicao de duas cadeias de caracteres e a juncao deles
0.8 08. ( _OK_ ) identificacao de programa
leitura e exibicao de dois valores reais e operacoes de potencia entre eles
0.9 09. ( _OK_ ) identificacao de programa
leitura e exibicao de diversas variaveis submetidas a diversas alteracoes e comparacoes
0.10 010. ( _OK_ ) identificacao de programa
leitura, exibicao e alteracao do valores de variaveis do tipo inteiro, real, char e bool, com o auxilio da biblioteca io.h
*/
